...
const string TARGET_STAGE = "routine";
var stage = pipelineSettings.Stages.First(s => s.Name == TARGET_STAGE);

const int MIN_DELAY_MS = 30000;
const int MAX_DELAY_MS = 180000;
const int ERROR_PERCENTAGE = 30;
const string? NEXT_STAGE = "notification";
